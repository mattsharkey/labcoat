...
class Report implements \IteratorAggregate {
  ...
  public function getDeletedCount() {
    return $this->getFilteredEventCount(function (FileEvent $e) { return $e->wasDeleted(); });
  }

  public function getSkippedCount() {
    return $this->getFilteredEventCount(function (FileEvent $e) { return $e->wasSkipped(); });
  }

  public function getUpdatedCount() {
    return $this->getFilteredEventCount(function (FileEvent $e) { return $e->wasUpdated(); });
  }
